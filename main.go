...
type Training struct {
	...
	Duration     time.Duration // продолжительность тренировки (нс(int64))
...
type InfoMessage struct {
	...
	TrainingType string        // тип тренировки
	Duration     time.Duration // длительность тренировки (нс(int64))
...
const (
	SwimmingLenStep                  = 1.38 // длина одного гребка (м)
